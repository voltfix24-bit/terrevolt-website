...
const faqs = [
  { q: "Wat betekent BEI BLS/BHS?", a: "BEI-BLS is de Bedrijfsvoering van Elektrische Installaties voor laagspanning, BEI-BHS voor hoog- en middenspanning binnen de elektriciteitsvoorzieningssystemen van netbeheerders. De norm legt vast welke aanwijzingen (WV, AVP, VP, VOP), procedures en instructies gelden bij werkzaamheden aan of nabij elektrische installaties. TerreVolt werkt volgens deze structuur en stemt rollen, bevoegdheden en werkmethodes per project af op de geldende BEI-versie en de eisen van de netbeheerder." },
  { q: "Wat zijn VWI's?", a: "VWI's zijn Veiligheidswerkinstructies: gestandaardiseerde werkbeschrijvingen die binnen de BEI-systematiek bepalen hoe een specifieke handeling (zoals schakelen, spanningsloos maken, meten of beproeven) veilig wordt uitgevoerd. Ze beschrijven stap voor stap de voorbereiding, benodigde PBM's, rolverdeling en controlepunten. TerreVolt gebruikt de VWI die hoort bij de werkzaamheid en de installatie, en wijkt daar niet zonder afstemming van af." },
  { q: "Werkt TerreVolt volgens netbeheerderseisen?", a: "Ja. Per opdracht stemmen we af welke netbeheerder-specifieke procedures, poortinstructies, aanwijsbeleid en kwaliteitseisen van toepassing zijn. Denk aan eisen rond toegang tot stations, registratie van schakelhandelingen, gebruik van vergrendelingen, oplevering en aantoonbaarheid. We sluiten aan op het BEI-regime en de aanvullende bedrijfsvoorschriften van de betreffende netbeheerder of opdrachtgever." },
  { q: "Wat als een situatie niet veilig voelt?", a: "Dan wordt er gestopt. Iedere monteur, uitvoerder of betrokkene heeft het recht én de plicht om werk stil te leggen bij twijfel. De situatie wordt gemeld bij de werkverantwoordelijke en/of opdrachtgever, opnieuw beoordeeld via een LMRA en pas hervat als het aantoonbaar veilig kan. We doen het veilig, of we doen het niet — er is geen project belangrijker dan iemand veilig thuis." },
  { q: "Is VCA verplicht?", a: "VCA is wettelijk niet altijd verplicht, maar wordt door vrijwel alle netbeheerders, hoofdaannemers en industriële opdrachtgevers contractueel geëist voor werk aan elektrische infrastructuur. TerreVolt zorgt dat medewerkers en ingehuurde ZZP'ers beschikken over een geldig VCA-certificaat (Basis of VOL) waar dat vereist is, naast de specifieke BEI-aanwijzingen, NEN 3140/3840-instructies en eventuele aanvullende opleidingen die het project vraagt." },
  { q: "Wie is verantwoordelijk voor veilig werken?", a: "Veiligheid is een gedeelde verantwoordelijkheid binnen een duidelijke rolverdeling. De Installatieverantwoordelijke (IV) en Werkverantwoordelijke (WV) zijn formeel verantwoordelijk voor de installatie en het werk. De AVP/VP bereidt voor en geeft opdracht, de VOP voert uit binnen zijn bevoegdheid. Daarnaast hebben opdrachtgever, uitvoerder en iedere monteur de plicht om risico's te signaleren, een LMRA uit te voeren, elkaar aan te spreken en niet weg te kijken. Bij TerreVolt geldt: iedereen is verantwoordelijk, niemand staat er alleen voor." },
];
