...
const faqs = [
  ...
  { q: "Is VCA verplicht?", a: "VCA is wettelijk niet altijd verplicht, maar wordt door veel netbeheerders, hoofdaannemers en industriële opdrachtgevers contractueel geëist voor werk aan elektrische infrastructuur. TerreVolt streeft ernaar dat medewerkers en ingehuurde ZZP'ers, afgestemd op de opdracht en locatie, beschikken over een geldig VCA-certificaat (Basis of VOL), naast de specifieke BEI-aanwijzingen, NEN 3140/3840-instructies en eventuele aanvullende opleidingen die het project volgens de geldende projectafspraken vraagt." },
          ...
          <div className="container mx-auto px-5 sm:px-6 lg:px-12 relative z-10">
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  Veilige voorbereiding bespreken
                </a>
              </div>
            </div>
          </div>
