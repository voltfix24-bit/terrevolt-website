 ...
 * Op smalle telefoons blijft het logo 44px, op desktop cap't 't op 54px.
 * Breedte is ~3.89x de hoogte, dus desktop ongeveer 210px.
...
for (const width of WIDTHS) {
  test(`logo @ ${width}px`, async ({ page }) => {
    ...
    expect(svgInfo!.height).toBeLessThanOrEqual(55);
